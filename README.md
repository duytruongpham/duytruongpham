...
- [frectonz/sql-studio](https://github.com/frectonz/sql-studio) - SQL Database Explorer [SQLite, libSQL, PostgreSQL, MySQL/MariaDB, DuckDB] (4 days ago)
...
- [squaredtechnologies/thread](https://github.com/squaredtechnologies/thread) - An AI-powered Python notebook built in React — use AI to generate and edit code cells, automatically fix errors, and chat with your code (1 week ago)
...
- [unclecode/crawl4ai](https://github.com/unclecode/crawl4ai) - 🔥🕷️ Crawl4AI: Open-source LLM Friendly Web Crawler &amp; Scrapper (2 weeks ago)
...
- [mistralai/mistral-finetune](https://github.com/mistralai/mistral-finetune) -  (3 weeks ago)

...
- [WeAreMahsaAmini/Core](https://github.com/WeAreMahsaAmini/Core) - Woman, life, freedom (6 days ago)
...
- [nv-tlabs/GET3D](https://github.com/nv-tlabs/GET3D) -  (4 weeks ago)
- [openai/whisper](https://github.com/openai/whisper) - Robust Speech Recognition via Large-Scale Weak Supervision (1 month ago)
- [carson-katri/dream-textures](https://github.com/carson-katri/dream-textures) - Stable Diffusion built-in to the Blender shader editor (1 month ago)

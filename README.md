...
- [tamnd/kage](https://github.com/tamnd/kage) - Shadow any website for offline viewing, with the JavaScript stripped out (today)
- [BuilderIO/skills](https://github.com/BuilderIO/skills) - Skills for coding agents (2 days ago)
...
- [inkeep/open-knowledge](https://github.com/inkeep/open-knowledge) - Beautiful, AI-native markdown editor and LLM wiki (1 week ago)

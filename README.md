...
- [HKUDS/OpenSpace](https://github.com/HKUDS/OpenSpace) - &#34;OpenSpace: Make Your Agents: Smarter, Low-Cost, Self-Evolving&#34; -- Community: https://open-space.cloud/ (5 days ago)
- [paoloanzn/free-code](https://github.com/paoloanzn/free-code) - [NOTE] Parent repo is migrating ownership, until the operation is done this repo is blocked. The free build of Claude Code. All telemetry removed, security-prompt guardrails stripped, all experimental features enabled. (6 days ago)
